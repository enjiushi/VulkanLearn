...
public:
	...
	virtual void ProcessMouse(KeyState keyState, const Vector2f& mousePosition) = 0;
	virtual void ProcessMouse(const Vector2f& mousePosition) = 0;
};
...
public:
	...
	void ProcessMouse(KeyState keyState, const Vector2f& mousePosition);
	void ProcessMouse(const Vector2f& mousePosition);
