...
public:
	...
	std::shared_ptr<PerMeshUniforms> GetPerMeshUniforms() const { return std::dynamic_pointer_cast<PerMeshUniforms>(m_uniformStorageBuffers[UniformStorageType::PerMeshBuffer]); }
