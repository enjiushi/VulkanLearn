...
layout(set = 0, binding = 17) uniform sampler2D DELTA_IRRADIANCE;
layout(set = 0, binding = 18) uniform sampler3D DELTA_RAYLEIGH;
layout(set = 0, binding = 19) uniform sampler3D DELTA_MIE;
layout(set = 0, binding = 20) uniform sampler3D DELTA_SCATTER_DENSITY;
