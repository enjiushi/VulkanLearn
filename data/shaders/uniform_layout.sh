...
layout(set = 0, binding = 20) uniform samplerCube RGBA16_512_CUBE_SKYBOX1[2];
layout(set = 0, binding = 21) uniform samplerCube RGBA16_512_CUBE_IRRADIANCE1[2];
layout(set = 0, binding = 22) uniform samplerCube RGBA16_512_CUBE_PREFILTERENV1[2];
